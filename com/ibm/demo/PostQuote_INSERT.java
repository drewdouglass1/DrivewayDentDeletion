...
public class PostQuote_INSERT extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
    		...
    		String sql = "INSERT INTO QUOTES(Name,EMail,Address,USState,LicensePlate) VALUES(?,?,?,?,?) RETURNING *";
	        
	        PreparedStatement pstmt = conn.prepareStatement(sql);
	        pstmt.setObject(1, name);
	        pstmt.setObject(2, email);
	        pstmt.setObject(3, address);
	        pstmt.setObject(4, usState);
	        pstmt.setObject(5, licensePlate);
